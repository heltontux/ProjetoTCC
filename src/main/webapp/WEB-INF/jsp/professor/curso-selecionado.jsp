...
<html lang="pt-br">
	...
	<h3>
		<a href="/professor/cadastrar-conteudo">Incluir conteudo de aula</a> <p>
		<a href="inicio">Incluir Material de apoio</a> <p>
		<a href="/professor/listagem-curso">Voltar</a>
	</h3>
    ...
    <tbody>
     <c:forEach var="conteudo" items="${conteudos}">
      <tr>
      	...
      	<td>${conteudo.dia}</td>
      	<td>${conteudo.hora}</td>
        <td><a href="/professor/${conteudo.idConteudo}/exibir-conteudo">Editar</a></td>
      </tr>
      </c:forEach>
    </tbody>
  	</table>
